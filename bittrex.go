...
func (b *Bittrex) GetMarketSummaries() (marketSummaries []MarketSummary, err error, ra []byte) {
...
func (b *Bittrex) GetMarketSummary(market string) (marketSummary []MarketSummary, err error, ra []byte) {
...
func (b *Bittrex) GetOrderBook(market, cat string, depth int) (orderBook OrderBook, err error,ra []byte) {
...
func (b *Bittrex) GetOpenOrders(market string) (openOrders []Order, err error,ra []byte) {
